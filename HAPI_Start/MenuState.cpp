...
void MenuState::Initialise(Graphics *Viz, std::shared_ptr<Sound> sound)
{
	...
	std::shared_ptr <Button> newButton = std::make_shared<Button>("Load Game", vector2D(380, 300), Rectangle(210, 50));
	buttons.push_back(newButton);

	std::shared_ptr <Button> newButton1 = std::make_shared<Button>("Options", vector2D(410, 350), Rectangle(140, 50));
	buttons.push_back(newButton1);

	std::shared_ptr <Button> newButton2 = std::make_shared<Button>("Exit", vector2D(440, 400), Rectangle(90, 50));
	buttons.push_back(newButton2);
}

void MenuState::HandleInput(World *game)
{
...
void MenuState::Update(World *game, Graphics *Viz, std::shared_ptr<Sound> sound)
{

}

void MenuState::Render(World *game, Graphics *Viz)
{
	Viz->clearScreen(255);
	for (auto p : objects)
	{
